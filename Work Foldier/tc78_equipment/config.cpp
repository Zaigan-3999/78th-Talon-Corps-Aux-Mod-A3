...
class CfgWeapons
{
	...
	/// Helmets
		...
		class TC_CR_phase2_helmet: lsd_gar_phase2_helmet
		{
			...
			hiddenSelectionsTextures[]=
			{
				"tc78_equipment\data\helmets78th_CR_Helmet_camo1_co.paa",
				"ls_armor_bluefor\helmet\gar\phase2\data\visor_co.paa"
			};
		};
		class TC_CR_C_phase2_helmet: lsd_gar_phase2_helmet
		{
			...
			hiddenSelectionsTextures[]=
			{
				"tc78_equipment\data\helmets78th_CR_C_Helmet_camo1_co.paa",
				"ls_armor_bluefor\helmet\gar\phase2\data\visor_co.paa"
			};
		};
	...
	/// Uniforms
		...
		/// Medic
			...
			class TC_CE_uniform: ls_gar_phase2_uniform
			{
				...
				class ItemInfo: ItemInfo
				{
					uniformClass="78_CE_Medic_phase2";
				};
			};
...
class CfgVehicles
{
	...
	class 78_CT_Medic_phase2: lsd_gar_phase2_base
	{
		...
		hiddenSelectionsTextures[]=
		{
			...
			"\tc78_equipment\data\78th_CM_camo2_co.paa",
			"\ls_armor_bluefor\uniform\gar\phase2\data\undersuit_co.paa"
		};
	};
